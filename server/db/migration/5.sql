...
ALTER TABLE urls ADD COLUMN FAIL_COUNT INT DEFAULT 0;
...
-- 4. conditions: date_calc, disabled
-- -----------------------------------------
ALTER TABLE condurls ADD COLUMN DATE_CALC TIMESTAMP WITH TIME ZONE;
...
ALTER TABLE conditions ADD COLUMN CONDITION_LOCKED BOOLEAN DEFAULT FALSE;
...
GRANT CONNECT,TEMPORARY ON DATABASE seo TO webadministrator;
